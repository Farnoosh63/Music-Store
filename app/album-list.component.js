    ...
    return {
        ...
        execute: function() {
            AlbumListComponent = (function () {
                ...
                AlbumListComponent.prototype.createcompleteAlbum = function (name, artist, price, genre) {
                    this.currentAlbum.push(new album_model_1.Album(name, this.albumList.length), new album_model_1.Album(artist, this.albumList.length), new album_model_1.Album(price, this.albumList.length), new album_model_1.Album(genre, this.albumList.length));
                };
                // end code block
